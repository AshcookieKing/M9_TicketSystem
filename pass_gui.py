...
HELP_SECTIONS = [
    ...
    (
        "Протяжки",
        "Вкладка «Протяжки» готовит письмо техническому директору АО «ММТС-9» (Ушмайкин К.Э.) "
        "на монтаж или демонтаж соединительной линии — тот же бланк, что 04-08.743 и C03036.\n\n"
        "Вставьте письмо клиента или уведомление ДЦ и при необходимости JSON-задание линии. "
        "Отказ от кроссировок («Прошу отказаться от кроссировок: 5276/25 и 5959/24») собирает "
        "демонтаж с номерами исходных заданий. Уведомление о передаче протяжек (инв. C03036, "
        "стойки, разъёмы, клиент) собирает монтаж, в том числе в комнату ГО.\n\n"
        "В PDF уходит таблица сторон A/B, тариф, контакт инженера и при монтаже круглая печать ТЕХ.РУ. "
        "Рядом сохраняется JSON задания. Подписывает инженер (Порозов, Пронякин и др.), не гендиректор.",
    ),
    (
        "Обновления",
